...
/** Unit tests for FastURLNormalizer. */
public class TestFastURLNormalizer extends TestCase {
  private FastURLNormalizer normalizer;
  private Configuration conf;
  
  public TestFastURLNormalizer(String name) {
    super(name);
    normalizer = new FastURLNormalizer();
  ...
  public static void main(String[] args) throws Exception {
    new TestFastURLNormalizer("test").testNormalizer();
  }
